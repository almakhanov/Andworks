...
class PopularFragment : Fragment(), SalonsAdapter.NewsItemClicked {
    ...
    private fun getPopularList() {
        ...
        dataSet.apply {
            add(Salon(0, "Очень пополулярная тема", "12-10-2018",
    ...
    fun setNewsList(newsList: ArrayList<Salon>) {
        ...
        recycler_popular.adapter = SalonsAdapter(activity!!, newsList, this)
    }

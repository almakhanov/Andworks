...
import kz.batana.timer.AppConstants
import kz.batana.timer.MainActivity
import kz.batana.timer.R
import kz.batana.timer.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        fun showTimerPaused(context: Context){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Timer is used!")
        ...
        : NotificationCompat.Builder{
            ...
            val nBulder = NotificationCompat.Builder(context, channelID)
                    .setSmallIcon(R.drawable.ic_timer)
                    .setAutoCancel(true)
                    .setDefaults(0)

            if(playSound) nBulder.setSound(notificationSound)
